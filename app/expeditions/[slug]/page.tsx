...
export function generateStaticParams() {
  return tripStaticParams('expedition');
}

export function generateMetadata({ params }: { params: Promise<Params> }): Promise<Metadata> {
  return tripMetadata('expedition', params);
}

export default function ExpeditionDetailPage({ params }: { params: Promise<Params> }) {
  return <TripDetailPage category="expedition" params={params} />;
}
